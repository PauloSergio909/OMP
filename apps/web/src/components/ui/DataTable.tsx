            ...
            {isLoading ? (
              <tr>
                <td colSpan={columns.length} className="px-5 py-12 text-center">
                  <div className="w-8 h-8 border-[3px] border-fleet-accent border-t-transparent rounded-full animate-spin mx-auto mb-3" />
              ...
              data.map((row, rowIndex) => (
                <tr key={row[keyField] ?? rowIndex} className="hover:bg-gray-50/50 transition-colors">
                  {columns.map((col) => (
